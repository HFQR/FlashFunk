...
#[no_mangle]
pub unsafe extern "C" fn RustCtpMiniActionOnRspSubMarketData(this: *mut ::std::os::raw::c_void, pSpecificInstrument: *mut CThostFtdcSpecificInstrumentField, pRspInfo: *mut CThostFtdcRspInfoField, nRequestID: c_int, bIsLast: *mut bool) {
    let instance = **(this as *mut *mut &mut dyn CtpMiniMdApi);
    instance.on_rsp_sub_market_data(pSpecificInstrument, pRspInfo, nRequestID, bIsLast);
}

#[no_mangle]
pub unsafe extern "C" fn RustCtpMiniActionOnRspUnSubMarketData(this: *mut ::std::os::raw::c_void, pSpecificInstrument: *mut CThostFtdcSpecificInstrumentField, pRspInfo: *mut CThostFtdcRspInfoField, nRequestID: c_int, bIsLast: *mut bool) {
    let instance = **(this as *mut *mut &mut dyn CtpMiniMdApi);
    instance.on_rsp_un_sub_market_data(pSpecificInstrument, pRspInfo, nRequestID, bIsLast);
}

#[no_mangle]
pub unsafe extern "C" fn RustCtpMiniActionOnRspSubForQuoteRsp(this: *mut ::std::os::raw::c_void, pSpecificInstrument: *mut CThostFtdcSpecificInstrumentField, pRspInfo: *mut CThostFtdcRspInfoField, nRequestID: c_int, bIsLast: *mut bool) {
    let instance = **(this as *mut *mut &mut dyn CtpMiniMdApi);
    instance.on_rsp_sub_for_quote_rsp(pSpecificInstrument, pRspInfo, nRequestID, bIsLast);
}

#[no_mangle]
pub unsafe extern "C" fn RustCtpMiniActionOnRspUnSubForQuoteRsp(this: *mut ::std::os::raw::c_void, pSpecificInstrument: *mut CThostFtdcSpecificInstrumentField, pRspInfo: *mut CThostFtdcRspInfoField, nRequestID: c_int, bIsLast: *mut bool) {
    let instance = **(this as *mut *mut &mut dyn CtpMiniMdApi);
    instance.on_rsp_un_sub_for_quote_rsp(pSpecificInstrument, pRspInfo, nRequestID, bIsLast);
}

#[no_mangle]
pub unsafe extern "C" fn RustCtpMiniActionOnRtnDepthMarketData(this: *mut ::std::os::raw::c_void, pDepthMarketData: *mut CThostFtdcDepthMarketDataField) {
    let instance = **(this as *mut *mut &mut dyn CtpMiniMdApi);
    instance.on_rtn_depth_market_data(pDepthMarketData);
}

#[no_mangle]
pub unsafe extern "C" fn RustCtpMiniActionOnRtnMBLMarketData(this: *mut ::std::os::raw::c_void, pMBLMarketData: *mut CThostFtdcMBLMarketDataField) {
    let instance = **(this as *mut *mut &mut dyn CtpMiniMdApi);
