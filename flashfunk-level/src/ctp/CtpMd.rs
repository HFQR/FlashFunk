...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnFrontDisconnected(
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnHeartBeatWarning(
    this: *mut ::std::os::raw::c_void,
    nTimeLapse: c_int,
) {
    let instance = get_api(this);
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnRspUserLogin(
    this: *mut ::std::os::raw::c_void,
    pRspUserLogin: *mut CThostFtdcRspUserLoginField,
    pRspInfo: *mut CThostFtdcRspInfoField,
    nRequestID: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnRspUserLogout(
    this: *mut ::std::os::raw::c_void,
    pUserLogout: *mut CThostFtdcUserLogoutField,
    pRspInfo: *mut CThostFtdcRspInfoField,
    nRequestID: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnRspError(
    this: *mut ::std::os::raw::c_void,
    pRspInfo: *mut CThostFtdcRspInfoField,
    nRequestID: c_int,
    bIsLast: bool,
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnRspSubMarketData(
    this: *mut ::std::os::raw::c_void,
    pSpecificInstrument: *mut CThostFtdcSpecificInstrumentField,
    pRspInfo: *mut CThostFtdcRspInfoField,
    nRequestID: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnRspUnSubMarketData(
    this: *mut ::std::os::raw::c_void,
    pSpecificInstrument: *mut CThostFtdcSpecificInstrumentField,
    pRspInfo: *mut CThostFtdcRspInfoField,
    nRequestID: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnRspSubForQuoteRsp(
    this: *mut ::std::os::raw::c_void,
    pSpecificInstrument: *mut CThostFtdcSpecificInstrumentField,
    pRspInfo: *mut CThostFtdcRspInfoField,
    nRequestID: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnRspUnSubForQuoteRsp(
    this: *mut ::std::os::raw::c_void,
    pSpecificInstrument: *mut CThostFtdcSpecificInstrumentField,
    pRspInfo: *mut CThostFtdcRspInfoField,
    nRequestID: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnRtnDepthMarketData(
    this: *mut ::std::os::raw::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn RustCtpActionMdOnRtnForQuoteRsp(
    this: *mut ::std::os::raw::c_void,
